      ...
      <Layout>
        ...
        <Intro>
          <ContainerLayout>
            ...
            <HeaderIntro>
              <SubText>
                Artículos sobre desarrollo de software, donde explico mi proceso
                a la hora de diseñar un sistema, y distintos algoritmos usados
                    ...
                    <div className="content">
                      <header>
                        ...
                        <SmallText>
                          ...
                          <span className="align-middle">
                            {" "}
                            Tiempo de lectura : {node.frontmatter.time}{" "}
                          </span>
                        </SmallText>
                      </header>
                      <Text
